    ...
    <>
      {isOpen && (
        <div className="app-container-shopping-cart">
          <div className="wrapper-close-shopping-cart" onClick={closeCart}></div>
          <div className="wrapper-shopping-cart">
            ...
            {cartQuantity === 0 ? (
              <div className="shopping-cart-body shopping-empty-cart">
                ...
                <span className="ad-empty-cart">Tu carrito está vacío</span>
              </div>
            ) : (
              <>
                    ...
                    <span>
                      ...
                      {cartItems
                        .reduce((descuentoTotal, cartItem) => {
                          ...
                          return descuentoTotal + (descuento || 0) * cartItem.quantity;
                        }, 0)
                        .toFixed(2)}
                    </span>
                  </div>
                  <button onClick={() => Comprar()} className="shopping-cart-footer-btn">
                    Finalizar compra
                  </button>
                </div>
              </>
