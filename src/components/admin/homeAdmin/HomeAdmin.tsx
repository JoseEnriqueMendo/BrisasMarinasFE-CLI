      ...
      <div className="wrapper-home-admin">
        ...
        <div className="container-manage-books">
          <div className="container-manage-books-header">
            ...
            <button className="btns-manage-add" onClick={() => navigate('/addBook')}>
              Añadir Libro
            </button>
          </div>
                ...
                {booksSeller.map((book) => {
                  return (
                    <tr key={book.id}>
                      ...
                      <td>S/ {book.price}</td>
                      <td>
                        {book.percentDiscount ? `${book.percentDiscount}%` : 'Sin descuento'}
                      </td>
                      ...
                      <td className="wrapper-btns-manage">
                        <ul className="btns-manage">
                          ...
                          <li
                            ...
                            onClick={() => navigate(`/detailsBook/${book.id}`)}
                          >
                            Detalles
                          </li>
                          <li
                ...
                {userAdmin.map((user) => {
                  return (
                    <tr key={user.idcliente}>
                      ...
                      <td className="wrapper-btns-manage">
                        <ul className="btns-manage">
                          <li className="btns-manage-edit">Editar</li>

                          <li className="btns-manage-detail">Detalles</li>
                          <li className="btns-manage-delete">Eliminar</li>
                        </ul>
                      </td>
                    </tr>
                  );
